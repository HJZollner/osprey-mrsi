%% jobMRSI_TE_15_in_vitro_SPARSDAT.m
...
opts.MRSI.LCM.ModelProcedureFileMetabolites = which('/model-procedures/mrsi/3Step_Spline_in_vitro_Reg_Optim_MRSI.json');
...
opts.MRSI.GlobalConc.metabolites = {'tNAA','tCho','mI','Glx'};
...
opts.MRSI.atlas.metabolites = {'tNAA','tCho','mI','Glx'};
...
% (MANDATORY)
files       = {which(fullfile('exampledata','mrsi','Philips','TE_15_braino_phantom','mrs','5SL_MRSI_TE_15_raw_act.sdat'))};
...
% (OPTIONAL)
files_w     = {which(fullfile('exampledata','mrsi','Philips','TE_15_braino_phantom','mrs','5SL_H2O_MRSI_raw_act.sdat'))};
...
files_nii   = {which(fullfile('exampledata','mrsi','Philips','TE_15_braino_phantom','anat_nii','T1w_anat.nii.gz'))};
...
% (MANDATORY)
data_folder = fileparts(which(fullfile('exampledata','mrsi','Philips','TE_15_braino_phantom','jobMRSI_TE_15_in_vitro_SPARSDAT.m')));
