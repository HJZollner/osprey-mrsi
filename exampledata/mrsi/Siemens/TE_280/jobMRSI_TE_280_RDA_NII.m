...
% opts.MRSI.phase.BasisSetFile = {which('/fit/basissets/mrsi/BASIS_Siemens_UnEdited_PRESS_GABA280_noMM.mat')};
...
opts.MRSI.LCM.BasisSetFile = {which('/fit/basissets/mrsi/BASIS_Siemens_UnEdited_PRESS_GABA280_noMM.mat')};
...
% (MANDATORY)
files       = {which(fullfile('exampledata','mrsi','Siemens','TE_280','mrs_nii','1sl_metabolite_mrsi_raw_act.nii.gz'))};
...
files_nii   = {which(fullfile('exampledata','mrsi','Siemens','TE_280','anat_nii','T2w_anat.nii.gz'))};
...
% (MANDATORY)
data_folder = fileparts(which(fullfile('exampledata','mrsi','Siemens','TE_280','jobMRSI_TE_280_RDA_NII.m')));
