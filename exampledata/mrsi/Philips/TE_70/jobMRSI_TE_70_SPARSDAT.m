...
opts.MRSI.MaxEcho.phase.type = 'first-point';
...
% (MANDATORY)
data_folder = fileparts(which(fullfile('exampledata','mrsi','Philips','TE_70','jobMRSI_TE_70_SPARSDAT.m')));
