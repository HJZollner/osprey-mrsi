function [fieldmap MagVol]=BuildFieldmap(fNameMagImg,fNamePhaseImg, TE1, TE2)
%% ************************************************************************
...
magImg.vol=flip(flip(magImg.vol,1),3);
phaseImg.vol=flip(flip(phaseImg.vol,1),3);
...
% fieldmap= angle(squeeze(exp(2*pi*1i * phaseImg.vol)));

% Scale by the difference in echo times
%TE1      = 2.080;%4.92; %MGH 7T % HUG 3T
%TE2      = 3.100;%7.38;%MGH 7T % HUG 3T
...
fieldmap((MagVol< tHold)) = 0;
fieldmap=fieldmap -mean(fieldmap(:));
