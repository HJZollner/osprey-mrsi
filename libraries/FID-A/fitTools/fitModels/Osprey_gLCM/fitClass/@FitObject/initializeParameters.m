...
switch parameter                            % Switch with parameter names
    case {'ph0', 'ph1', 'GlobFreqShift', 'gaussLB'}
        % one parameter per spectrum
        nParamsPerSpec = 1;
    case {'metAmpl', 'freqShift', 'lorentzLB', 'lorentzLBright', 'lorentzLBleft'}
...
switch parameter                                            % Parameter switch with default parameters
    ...
    case 'GlobFreqShift'
        % Initialize global frequency shift as constant with value 0
        parametrizations.fun     = 'free';
        parametrizations.gradfun = 'free';
        parametrizations.lb      = -20;
        parametrizations.ub      = 20;
        parametrizations.init    = 0;
        parametrizations.ex      = 0;
    ...
    case {'lorentzLB','lorentzLBright','lorentzLBleft'}
...
if nargin == 3
    ...
    if obj.step > 1                                                         % Only needed for steps > 1
        if strcmp(parameter, 'lorentzLB') || strcmp(parameter, 'lorentzLBright') || strcmp(parameter, 'freqShift') % Only do this for non amplitude parameters
