...
out = osp_plotMetabolitemapsOverlay(MRSCont,'TissCorrWaterScaled','tCr_methyl',slice,slice,1,10,0,'T1w_rMRSIloc',0.8,0);
set(gcf,'Renderer', 'painters');
saveas(gcf,'Figure_2_tCr.pdf','pdf');
saveas(gcf,'Figure_2_tCr.fig','fig');
close(gcf);
out = osp_plotMetabolitemapsOverlay(MRSCont,'TissCorrWaterScaled','tCr_methyl',slice,slice,1,10,0,'T1w_rMRSIloc',0.8,1);
set(gcf,'Renderer', 'painters');
saveas(gcf,'Figure_2_tCr_cbar.pdf','pdf');
saveas(gcf,'Figure_2_tCr_cbar.fig','fig');
close(gcf);

out = osp_plotMetabolitemapsOverlay(MRSCont,'TissCorrWaterScaled','tCho_methyl',slice,slice,1,2,0,'T1w_rMRSIloc',0.8,0);
set(gcf,'Renderer', 'painters');
saveas(gcf,'Figure_2_tCho.pdf','pdf');
saveas(gcf,'Figure_2_tCho.fig','fig');
close(gcf);
out = osp_plotMetabolitemapsOverlay(MRSCont,'TissCorrWaterScaled','tCho_methyl',slice,slice,1,2,0,'T1w_rMRSIloc',0.8,1);
set(gcf,'Renderer', 'painters');
...
% CRLB
out = osp_plotMetabolitemapsOverlay(MRSCont,'CRLBs','tNAA_Acetyl',slice,slice,1,10,1,'T1w_rMRSIloc',0.8,0);
set(gcf,'Renderer', 'painters');
...
out = osp_plotMetabolitemapsOverlay(MRSCont,'CRLBs','tCr_methyl',slice,slice,1,25,1,'T1w_rMRSIloc',0.8,0);
set(gcf,'Renderer', 'painters');
saveas(gcf,'Figure_2_tCr_CRLBs.pdf','pdf');
saveas(gcf,'Figure_2_tCr_CRLBs.fig','fig');
close(gcf);
out = osp_plotMetabolitemapsOverlay(MRSCont,'CRLBs','tCr_methyl',slice,slice,1,25,1,'T1w_rMRSIloc',0.8,1);
set(gcf,'Renderer', 'painters');
saveas(gcf,'Figure_2_tCr_cbar_CRLBs.pdf','pdf');
saveas(gcf,'Figure_2_tCr_cbar_CRLBs.fig','fig');
close(gcf);

out = osp_plotMetabolitemapsOverlay(MRSCont,'CRLBs','tCho_methyl',slice,slice,1,50,1,'T1w_rMRSIloc',0.8,0);
set(gcf,'Renderer', 'painters');
...
% Metabolite maps
out = osp_plotMetabolitemapsOverlay(MRSCont,'TissCorrWaterScaled','tNAA',3,4,1,30,0,'T1w_rMRSIloc',0.8,0);
set(gcf,'Renderer', 'painters');
saveas(gcf,'Figure_3_tNAA.pdf','pdf');
saveas(gcf,'Figure_3_tNAA.fig','fig');
close(gcf);
out = osp_plotMetabolitemapsOverlay(MRSCont,'TissCorrWaterScaled','tNAA',3,4,1,30,0,'T1w_rMRSIloc',0.8,1);
set(gcf,'Renderer', 'painters');
...
out = osp_plotMetabolitemapsOverlay(MRSCont,'TissCorrWaterScaled','mI',3,4,1,12,0,'T1w_rMRSIloc',0.8,0);
set(gcf,'Renderer', 'painters');
saveas(gcf,'Figure_3_mI.pdf','pdf');
saveas(gcf,'Figure_3_mI.fig','fig');
close(gcf);
out = osp_plotMetabolitemapsOverlay(MRSCont,'TissCorrWaterScaled','mI',3,4,1,12,0,'T1w_rMRSIloc',0.8,1);
set(gcf,'Renderer', 'painters');
...
out = osp_plotMetabolitemapsOverlay(MRSCont,'CRLBs','tCho',3,4,1,30,1,'T1w_rMRSIloc',0.8,0);
set(gcf,'Renderer', 'painters');
saveas(gcf,'Figure_3_tCho_CRLBs.pdf','pdf');
saveas(gcf,'Figure_3_tCho_CRLBs.fig','fig');
close(gcf);
out = osp_plotMetabolitemapsOverlay(MRSCont,'CRLBs','tCho',3,4,1,30,1,'T1w_rMRSIloc',0.8,1);
set(gcf,'Renderer', 'painters');
saveas(gcf,'Figure_3_tCho_cbar_CRLBs.pdf','pdf');
saveas(gcf,'Figure_3_tCho_cbar_CRLBs.fig','fig');
close(gcf);

out = osp_plotMetabolitemapsOverlay(MRSCont,'CRLBs','mI',3,4,1,30,1,'T1w_rMRSIloc',0.8,0);
set(gcf,'Renderer', 'painters');
saveas(gcf,'Figure_3_mI_CRLBs.pdf','pdf');
saveas(gcf,'Figure_3_mI_CRLBs.fig','fig');
close(gcf);
out = osp_plotMetabolitemapsOverlay(MRSCont,'CRLBs','mI',3,4,1,30,1,'T1w_rMRSIloc',0.8,1);
set(gcf,'Renderer', 'painters');
saveas(gcf,'Figure_3_mI_cbar_CRLBs.pdf','pdf');
saveas(gcf,'Figure_3_mI_cbar_CRLBs.fig','fig');
close(gcf);

out = osp_plotMetabolitemapsOverlay(MRSCont,'CRLBs','Glx',3,4,1,30,1,'T1w_rMRSIloc',0.8,0);
set(gcf,'Renderer', 'painters');
saveas(gcf,'Figure_3_Glx_CRLBs.pdf','pdf');
saveas(gcf,'Figure_3_Glx_CRLBs.fig','fig');
close(gcf);
out = osp_plotMetabolitemapsOverlay(MRSCont,'CRLBs','Glx',3,4,1,30,1,'T1w_rMRSIloc',0.8,1);
set(gcf,'Renderer', 'painters');
...
out = osp_plotSpecAndLocMRSI(MRSCont,[10,7,1;11,7,1;10,9,1;], 'T1w_rMRSI','OspreyFit','metab','Fit1DStack',0,2,2,0,1);
set(gcf, 'units','normalized','outerposition',[0 0 1 0.66]);
set(gcf,'Renderer', 'painters');
