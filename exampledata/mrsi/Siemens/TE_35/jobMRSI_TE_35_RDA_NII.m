...
opts.MRSI.LCM.BasisSetFile = {which('/fit/basissets/mrsi/BASIS_Siemens_UnEdited_PRESS_GABA35_noMM.mat')};
...
files_nii   = {which(fullfile('exampledata','mrsi','Siemens','TE_35','anat_nii','T2w_anat.nii.gz'))};
...
% (MANDATORY)
data_folder = fileparts(which(fullfile('exampledata','mrsi','Siemens','TE_35','jobMRSI_TE_35_RDA_NII.m')));
