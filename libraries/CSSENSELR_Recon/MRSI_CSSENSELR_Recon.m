function MRSI_CSSENSELR_Recon(mrsiReconParams)
...
Data_name = mrsiReconParams.Data_name;
LipidRemStrength = mrsiReconParams.LipidRemStrength;

if mrsiReconParams.FreqWindow4Recon
    if ~isfield(mrsiReconParams,'MinPPM')
...
if mrsiReconParams.LimitAcqBW
    if ~isfield(mrsiReconParams,'MaxSweepwidth')
        if mrsiReconParams.FieldStrength==7
...
if ~isfield(mrsiReconParams,'LipidMaxPPM')
...
if ~isfield(mrsiReconParams,'WaterRefFreqSearchRange')
    mrsiReconParams.WaterRefFreqSearchRange =25*mrsiReconParams.FieldStrength;
else
    mrsiReconParams.WaterRefFreqSearchRange =mrsiReconParams.WaterRefFreqSearchRange*mrsiReconParams.FieldStrength;
end

if ~isfield(mrsiReconParams,'AutoMask_Quantile')
...
if ~isfield(mrsiReconParams,'GaussianSigma')
...
if ~isfield(mrsiReconParams,'FiltParam')
    if mrsiReconParams.FieldStrength==7
...
if ~isfield(mrsiReconParams,'WaterSuppComp')
    mrsiReconParams.FiltParam.Comp=WaterSuppComp; % 0 for no Water residual suppression
else
    mrsiReconParams.FiltParam.Comp=mrsiReconParams.WaterSuppComp;
end

if ~isfield(mrsiReconParams,'SideBandRMRank')
...
% Do Water Supression
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
VisualizeKmasks( mrsiReconParams.mrsiData_ctkkk,mrsiReconParams.kmask, mrsiReconParams.Water_ctkkk ,mrsiReconParams.Water_kmask,[mrsiReconParams.Log_Dir filesep mrsiReconParams.NameData]);
...
VisualizeKmasks( mrsiReconParams.mrsiData_ctkkk,mrsiReconParams.kmask, mrsiReconParams.Water_ctkkk ,mrsiReconParams.Water_kmask,[mrsiReconParams.Log_Dir filesep mrsiReconParams.NameData]);
VisualizeData( mrsiReconParams.mrsiData_ctkkk, mrsiReconParams.Water_ctkkk ,[mrsiReconParams.Log_Dir filesep mrsiReconParams.NameData '_OriginalData']);
VisualizeMasks( mrsiReconParams.Water_ctkkk,mrsiReconParams.ImMask ,mrsiReconParams.BrainMask, mrsiReconParams.SkMask,[mrsiReconParams.Log_Dir filesep mrsiReconParams.NameData '_WaterData']);
VisualizeCombinedData(mrsiReconParams.mrsiData_ctkkk, mrsiReconParams.Water_rrr ,mrsiReconParams,[mrsiReconParams.Log_Dir filesep mrsiReconParams.NameData '_OriginalData']);
...
VisualizeData( mrsiReconParams.mrsiData_ctkkk, mrsiReconParams.Water_ctkkk ,[mrsiReconParams.Log_Dir filesep mrsiReconParams.NameData '_BeforeLipidSupp']);
...
if (mrsiReconParams.LipidRemovalParams.LipidRemStrength>0)
    ...
    VisualizeMasks( mrsiReconParams.mrsiData_ctkkk, mrsiReconParams.ImMask ,mrsiReconParams.BrainMask, mrsiReconParams.SkMask,[mrsiReconParams.Log_Dir filesep mrsiReconParams.NameData '_MRSIData_WaterResdiual-in-SkullMask' ]);
