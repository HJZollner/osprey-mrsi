%% jobMRSI_TE_30_in_vitro_P_NII_ax.m
...
% (MANDATORY)
files       = {which(fullfile('exampledata','mrsi','GE','TE_30_phantom_acr','mrs_nii','mrsi_ax','1sl_metabolite_te_30_mrsi_raw_act_noID.nii.gz'))};
...
% (MANDATORY)
data_folder = fileparts(which(fullfile('exampledata','mrsi','GE','TE_30_phantom_acr','jobMRSI_TE_30_in_vitro_P_NII_ax.m')));
outputFolder = fullfile(data_folder, 'derivatives_ax');
