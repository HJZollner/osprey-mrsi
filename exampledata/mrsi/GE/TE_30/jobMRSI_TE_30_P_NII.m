...
opts.MRSI.LCM.BasisSetFile = {which('/fit/basissets/mrsi/BASIS_GE_UnEdited_sLASER_GABA30_noMM.mat')};
...
% (MANDATORY)
files       = {which(fullfile('exampledata','mrsi','GE','TE_30','mrs_nii','1sl_metabolite_mrsi_raw_act_noID.nii.gz'))};
...
files_nii   = {which(fullfile('exampledata','mrsi','GE','TE_30','anat_nii','T1w_anat.nii.gz'))};
...
% (MANDATORY)
data_folder = fileparts(which(fullfile('exampledata','mrsi','GE','TE_30','jobMRSI_TE_30_P_NII.m')));
